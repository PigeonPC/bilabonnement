...
(
    ...
    car_status              ENUM ('PURCHASED', 'PREPARATION_FOR_RENT', 'READY_FOR_RENT', 'RENTED', 'RETURNED', 'PREPARATION_FOR_SALE', 'READY_FOR_SALE', 'SOLD'),
...
/* ---------------- CAR (datoer flyttet til nov/dec 2025) ---------------- */

INSERT INTO cars (
    chassis_number, brand, model, equipment_level,
    steel_price, registration_tax, co2_emission, mileage,
    leasing_code, irk_code, date_of_purchase, purchase_price,
    car_status, status_change_timestamp
) VALUES
      -- Købt og klar til udlejning
      ('CAR001', 'Audi',    'A3',      'Base',
       155000.00, 72000.00, 115,  23000,
       'LC-A3-24', 'IRK-A1', '2025-11-01', 225000.00,
       'READY_FOR_RENT', '2025-11-05 09:15:00'),

      -- Lige nu udlejet
      ('CAR002', 'BMW',     '320i',    'Comfort',
       225000.00, 112000.00, 128, 17000,
       'LC-320-24', 'IRK-B1', '2025-11-03', 305000.00,
       'RENTED', '2025-11-10 14:30:00'),

      -- Tilbageleveret fra leje
      ('CAR003', 'Mercedes','C200',    'Sport',
       265000.00, 132000.00, 142, 13500,
       'LC-C2-24', 'IRK-C1', '2025-11-05', 365000.00,
       'RETURNED', '2025-11-20 16:45:00'),

      -- Under klargøring til udlejning
      ('CAR004', 'Toyota',  'Yaris',   'Premium',
       135000.00, 52000.00,  95, 52000,
       'LC-YA-24', 'IRK-D1', '2025-11-07', 185000.00,
       'PREPARATION_FOR_RENT', '2025-11-15 10:00:00'),

      -- Klar til salg
      ('CAR005', 'Volvo',   'XC60',    'Advanced',
       355000.00, 182000.00, 158, 11000,
       'LC-XC-24', 'IRK-E1', '2025-11-10', 525000.00,
       'READY_FOR_SALE', '2025-12-01 11:20:00'),

      -- Lige købt hjem
      ('CAR006', 'Skoda',   'Octavia', 'Comfort',
       195000.00, 82000.00, 118, 32000,
       'LC-OCT-24', 'IRK-F1', '2025-11-12', 275000.00,
       'PURCHASED', '2025-11-12 09:00:00'),

      -- Elbil, allerede solgt
      ('CAR007', 'Tesla',   'Model 3', 'Premium',
       330000.00, 0.00,       0, 14000,
       'LC-TM3-24', 'IRK-G1', '2025-11-15', 445000.00,
       'SOLD', '2025-12-05 13:10:00');
...
VALUES
    (8000, 7000, '2025-11-10', TRUE, 150, '2025-11-20 14:00:00', 1),
...
VALUES
    (TRUE,  '2025-11-02', 'Kbh',     15000, 1.5, 'Standard aftale',      'DKK', '2025-11-20', 1, 4),
