...
/* -------------------------- VIEW (kun læse) -------------------------- */
    ...
    // Viser skadesrapport for en bil ud fra vehicleId i URL'en.
// Opretter ALDRIG ny rapport her – viser enten eksisterende, eller en stabil tom formular.
...
// 2) Forbered et DamageReport-objekt UANSET hvad, så Thymeleaf altid har noget at binde til.
        ...
        if (leaseId == null) {
            ...
            report.getDamageItems().add(new DamageItem()); // mindst én række til binding
...
// 4) Når vi har leaseId, lægger vi altid lease-/bil-info i modellen
    ...
    public String saveDamageReport(@ModelAttribute DamageReport damageReport, Model model) {
        ...
        // Ved fejl → behold lease/bil-info og totals
